    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('trangchu')}}">
                ...
                <div class="sidebar-brand-text mx-3">E-Leaning</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    @endif
                    <div class="col-md-4">
                        <form asp-action="Create" action="{{route('update_matkhau')}}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                @enderror
                                <input class="form-control" value="" name="password_old" type="password" placeholder="Mật khẩu cũ">
                            ...
                            <div class="form-group">
                                ...
                                <div class="alert alert-danger" style="color: red;font-size:12px;padding-right: 30px;">{{ $message }}</div>
                                @enderror
                                <input class="form-control" value="" name="password_new" type="password" placeholder="Mật khẩu mới">
                                <span class="text-danger"></span>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="alert alert-danger" style="color: red;font-size:12px;padding-right: 30px;">{{ $message }}</div>
                                @enderror
                                <input class="form-control" value="" name="password_confirm" type="password" placeholder="Nhập lại mật khẩu">
                                <span class="text-danger"></span>
                            </div>
